...
- Evaluate 10 valid attempts on each of the three official levels.
...
extend all three levels to 25 attempts rather than selectively extending only
the most favorable or ambiguous level.
