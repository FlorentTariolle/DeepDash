...
> **Status:** V7 Geometry Dash is frozen as the application showcase. IRIS/Pong CE, fixed SLS, and annealed SLS single-seed runs are complete. Any conference/workshop venue will be decided after the benchmark freeze. Next paper-critical work is to turn the current result into defensible evidence: more seeds, preferably at least one more Atari game, stability/sample-efficiency KPIs, and the corresponding tables/plots.
