...
\begin{tikzpicture}[
  ...
  % Center the complete imagined-control pipeline within its panel. The small
  % downward shift balances the upper context route against the footer note.
  ...
  \node[note, anchor=west] at (-7.35,-5.28)
